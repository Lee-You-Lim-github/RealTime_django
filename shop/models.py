...
class Shop(models.Model):
    ...
    photo1 = models.ImageField(blank=True, null=True, upload_to='media/%Y/%m/%d')
    photo2 = models.ImageField(blank=True, null=True, upload_to='media/%Y/%m/%d')
    photo3 = models.ImageField(blank=True, null=True, upload_to='media/%Y/%m/%d')
